    ...
    <section id="servicios" aria-labelledby="services-title" className="py-24">
      <div className="section-container flex flex-col gap-16">
        <motion.div {...reveal('up')} className="max-w-3xl space-y-4">
          ...
          <h2 id="services-title" className="text-3xl font-semibold text-white sm:text-4xl">
            Automatizaciones, productos web y apps que sostienen operaciones reales
          </h2>
          <p className="text-white/70">
            Acompaño a startups y equipos internos en todo el ciclo: ideación, prototipado, desarrollo y escalado. Cada servicio
            combina estrategia de producto, diseño centrado en el usuario y la ingeniería necesaria para lanzar rápido con
            calidad.
          </p>
        </motion.div>
